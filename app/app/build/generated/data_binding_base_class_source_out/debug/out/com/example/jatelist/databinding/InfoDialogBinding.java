...
public final class InfoDialogBinding implements ViewBinding {
  ...
  private InfoDialogBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView3) {
  ...
  public static InfoDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new InfoDialogBinding((ConstraintLayout) rootView, textView3);
    }
